...
<Tabs>
    <TabItem label="Name" value='name'>
    ```
    _itsastro_
    ```
    </TabItem>
    <TabItem label="User ID" value='user'>
    ```
    1272681088938147951
    ```
    </TabItem>
    <TabItem label="Avatar URL" value='avatar'>
    ```
    https://cdn.discordapp.com/avatars/1272681088938147951/899966d4b5d1ff4c9371760a6aff236e.png
    ```
    </TabItem>
    <TabItem label="Mention" value='mention'>
    ```
    <@1272681088938147951>
    ```
    </TabItem>
...
<Tabs>
    ...
    <TabItem label="Channel ID" value='channel'>
    ```
    1252183491336994857
    ```
    </TabItem>
